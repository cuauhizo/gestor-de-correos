    ...
    <div v-if="editor" class="tiptap-toolbar">
      ...
      <div class="dropdown d-inline-block mx-1 border border-1 rounded">
        <button class="btn dropdown-toggle color-toggle-btn d-flex flex-column align-items-center justify-content-center" type="button" data-bs-toggle="dropdown" aria-expanded="false" title="Color del texto">
          <strong style="font-family: serif; font-size: 15px; line-height: 1">A</strong>
          <div :style="{ backgroundColor: editor.getAttributes('textStyle').color || '#000000', height: '4px', width: '15px', marginTop: '2px' }"></div>
        </button>
...
<style scoped>
  ...
  /* ESTILOS ESPECÍFICOS DEL COLOR PICKER */
  .color-toggle-btn {
  ...
  .color-toggle-btn::after {
    display: none; /* Oculta la flecha nativa de Bootstrap */
  }
